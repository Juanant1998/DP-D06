	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('CUSTOMER')">
			<li><a class="fNiv"><spring:message	code="master.page.customer" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="complaints/list.do"><spring:message code="master.page.customer.action.1" /></a></li>
					<li><a href="fixuptask/list.do"><spring:message code="master.page.customer.action.2" /></a></li>					
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="hasRole('HANDY WORKER')">
			<li><a class="fNiv"><spring:message	code="master.page.handyworker" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="referee/action-1.do"><spring:message code="master.page.handyworker.action.1" /></a></li>
					<li><a href="referee/action-2.do"><spring:message code="master.page.handyworker.action.2" /></a></li>
