...
<div>
	<a href="#"><img src="${bannerImage}" alt="Acme Handy Worker" /></a>
</div>
	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('REFEREE')">
			<li><a class="fNiv"><spring:message	code="master.page.referee" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="reports/referee/list.do"><spring:message code="master.page.referee.action.1" /></a></li>
					<li><a href="complaints/referee/list.do"><spring:message code="master.page.referee.action.2" /></a></li>		
				</ul>
			</li>
		</security:authorize>
