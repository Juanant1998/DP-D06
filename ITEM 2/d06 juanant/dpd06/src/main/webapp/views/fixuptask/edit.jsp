...
<%@taglib prefix="tiles" uri="http://tiles.apache.org/tags-tiles"%>
	...
	<form:form action="fixuptask/customer/edit.do" modelAttribute="fixuptask">
		...
		<form:input path="startDate" placeholder="01/01/2000" />
		...
		<form:input path="endDate" placeholder="01/01/2000" />
		...
		<form:select path="warranty">
		    ...
		    <form:options items="${warrantyList}" itemLabel="title" itemValue="id" />
		    </form:select>
